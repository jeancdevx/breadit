...
import { type CommentVoteValidatorType } from '@/libs/validators/vote'
import { usePrevious } from '@mantine/hooks'
import { type CommentVote, type VoteType } from '@prisma/client'
...
const CommentVotes: FC<CommentVotesProps> = ({
  ...
  const { mutate: vote } = useMutation({
    mutationFn: async (type: VoteType) => {
      const payload: CommentVoteValidatorType = {
        voteType: type,
        commentId
      }
